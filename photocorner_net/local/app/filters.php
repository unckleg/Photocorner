...
Route::filter('auth', function ()
{
    if (Auth::guest())
    {
        return Redirect::guest('login')->with('flashError', t('You need to Login first'));
    }
});
...
|
*/
Event::listen('image.views', 'Fotokutak\Events\ImageViewHandler');
...
|--------------------------------------------------------------------------
|
| Laravel fix for pagination with query string
|
*/
