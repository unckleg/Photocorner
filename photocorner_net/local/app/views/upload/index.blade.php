...
<div id="content-wrapper" class="snap-content">
    ...
    <div class="uploader block-hide">
        ...
        <div class="container preview-zone">
            <img src="{{ asset('static/plugin/img/mask-tran.png') }}"/>
        </div>
					...
					<div class="row">
						<div class="col-md-4 exif">
							...
							<div class="form-group">
								...
								{{ Form::select('photo[category]', array_pluck(siteCategories(), 'name', 'id'),1,array('class' => 'form-control', 'required' => 'required')) }}
							</div>
