<div class="util-list">
    <div class="btn-group">
        @if(Input::get('timeframe') && in_array(Input::get('timeframe'),['now','week','month','year']))
            <a href="#" data-toggle="dropdown">{{{ t(ucfirst(Input::get('timeframe'))) }}}<span class="caret"></span></a>
        @else
    ...
    <div class="btn-group">
        @if(Input::get('category'))
            <a href="#" data-toggle="dropdown">{{{ getCategoryName(Input::get('category')) }}}<span class="caret"></span></a>
        @else
